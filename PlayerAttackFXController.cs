...
public class PlayerAttackFXController : MonoBehaviour {
    ...
    public GameObject specialAttack_Prefab_1,
        specialAttack_Prefab_2, specialAttack_Prefab_3;

    public Transform specialAttack_Position_1,
        specialAttack_Position_2, specialAttack_Position_3, normalAttack_Position;
    ...
    void Spawn_SpecialAttackEffect_1() {
        ...
        if(is_BadeerAngel || is_Lei_Zhengzi) {
            ...
            Instantiate(specialAttack_Prefab_1,
                        specialAttack_Position_1.position, Quaternion.identity);
        ...
        if(is_Lian_You || is_Evil_King || is_Dark_Sorcerer) {
            ...
            Instantiate(specialAttack_Prefab_1,
                        specialAttack_Position_1.position, transform.rotation);
    ...
    void Spawn_SpecialAttackEffect_2() {
        ...
        if(is_Lei_Zhengzi || is_Evil_King) {
            ...
            Instantiate(specialAttack_Prefab_2, specialAttack_Position_2.position,
                        transform.rotation);
        ...
        if(is_Lian_You) {
            Instantiate(specialAttack_Prefab_2,
                        specialAttack_Position_2.position, Quaternion.identity);
        }
        ...
        if(is_Dark_Sorcerer) {
            ...
            Instantiate(specialAttack_Prefab_2,
                        specialAttack_Position_2.position, transform.rotation);

            Instantiate(specialAttack_Prefab_2,
                        specialAttack_Position_3.position, transform.rotation);
    ...
    void Spawn_SpecialAttackEffect_3() { 
        ...
        if(is_Lei_Zhengzi || is_BadeerAngel || is_Lian_You || is_Evil_King) {
            ...
            Instantiate(specialAttack_Prefab_3, specialAttack_Position_3.position,
                        transform.rotation);
        }

        if(is_Dark_Sorcerer) {

            Instantiate(specialAttack_Prefab_3,
                        specialAttack_Position_1.position, transform.rotation);
